...
const EduApp = () => {
  ...
  const handleSave = () => {
    // TODO: raccorder à la persistance Tauri
    console.info('Sauvegarde des paramètres en cours...');
  };
  ...
  return (
    <MainLayout activeTab={activeTab} onTabChange={setActiveTab} onSave={handleSave}>
      {renderContent()}
    </MainLayout>
  );
};
